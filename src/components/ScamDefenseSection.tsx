        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            {threats.map((threat) => (
              <div 
                key={threat.label}
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-surface border border-border/50"
              >
                <threat.icon size={16} className="text-destructive" />
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 mt-16 pt-8 border-t border-border/50 max-w-xl mx-auto">
            {[
